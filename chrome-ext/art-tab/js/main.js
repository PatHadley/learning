$(function(){
  ...
  // TateLoader
  artefactToLoad = '<div id="labels"><h1><a href="'+randomArtefact[0].link+'">'+randomArtefact[0].title+'</a></h1><p><a href="http://www.tate.org.uk/search?q='+randomArtefact[0].creator+'">'+randomArtefact[0].creator+'</a></p></div>';
